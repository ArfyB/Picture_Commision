$(function()
{
	function uploadImage(files) {
		...
		if(response.added)
		{
	        ...
	        for(var i = 0; i < list.length; i++)
	        {
	        	...
	        	$('#CExplainOrder_Contents').summernote('insertNode', img[0]);		
			}
	    }
	    else
	    {
	...
	$('#CExplainOrder_Contents').summernote({
	  ...
	  {
		var title = $('#Title').val();
		var Contents = $('#CExplainOrder_Contents').summernote('code');
		
		var formid = $('#CExplainOrderData')[0];
