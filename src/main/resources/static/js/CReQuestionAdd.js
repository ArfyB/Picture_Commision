$(function()
{
	function uploadImage(files) {
		...
		if(response.added)
		{
	        ...
	        for(var i = 0; i < list.length; i++)
	        {
	        	...
	        	$('#CReQuestion_Contents').summernote('insertNode', img[0]);		
			}
	    }
	    else
	    {
	...
	$('#CReQuestion_Contents').summernote({
	  ...
	  {
		var title = $('#Title').val();
		var Contents = $('#CReQuestion_Contents').summernote('code');
		
		var formid = $('#CReQuestion')[0];
